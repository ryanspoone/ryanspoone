...
const DATA = {
    ...
    latestBlogPosts: '<ul><li>Latest posts at <a href="https://www.delivr.ai/engineering">delivr.ai/engineering</a></li></ul>',
};
...
const setBlogPosts = async () => {
    try {
        ...
        if (!_.isEmpty(items)) {
            ...
            posts.push('<li>Latest posts at <a href="https://www.delivr.ai/engineering">delivr.ai/engineering</a></li>');
        }
        ...
        DATA.latestBlogPosts =
            '<ul><li>Latest posts at <a href="https://www.delivr.ai/engineering">delivr.ai/engineering</a></li></ul>';
    }
};
